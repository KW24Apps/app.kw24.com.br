 ...
 * Autenticação por token estático — NÃO depende de sessão PHP.
 * Token comparado contra configuracoes_sistema.monitoramento_equipe_token (fora do repositório git).
 */
